...
namespace QuanLyKhoHang
{
    public partial class frmCustomer : Form
    {
        ...
        {
            string sql = $"SELECT * FROM KhachHang WHERE TenKhachHang LIKE N'%{txtSearch.Text}%'";
            dgv.DataSource = db.GetDataTable(sql);
        }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                string sql = $"DELETE FROM KhachHang WHERE MaKhachHang = {txtID.Text}";
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (btnAdd.Text == "&Huỷ")
            {
                sql = $"INSERT INTO KhachHang VALUES (N'{txtName.Text}', '{txtPhone.Text}', N'{txtAddress.Text}')";
                btnAdd_Click(sender, e);
            }
            else
            {
                sql = $"UPDATE KhachHang SET TenKhachHang = N'{txtName.Text}', SoDienThoai = '{txtPhone.Text}', DiaChi = N'{txtAddress.Text}' WHERE MaKhachHang = {txtID.Text}";
