...
namespace QuanLyKhoHang
{
    public partial class frmSupplier : Form
    {
        ...
        {
            string sql = $"SELECT * FROM NhaCungCap WHERE TenNhaCungCap LIKE N'%{txtSearch.Text}%'";
            dgv.DataSource = db.GetDataTable(sql);
        }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                string sql = $"DELETE FROM NhaCungCap WHERE MaNhaCungCap = {txtID.Text}";
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (btnAdd.Text == "&Huỷ")
            {
                sql = $"INSERT INTO NhaCungCap VALUES (N'{txtName.Text}', '{txtPhone.Text}', N'{txtAddress.Text}')";
                btnAdd_Click(sender, e);
            }
            else
            {
                sql = $"UPDATE NhaCungCap SET TenNhaCungCap = N'{txtName.Text}', SoDienThoai = '{txtPhone.Text}', DiaChi = N'{txtAddress.Text}' WHERE MaNhaCungCap = {txtID.Text}";
